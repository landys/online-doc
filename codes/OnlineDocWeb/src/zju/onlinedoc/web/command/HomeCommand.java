...
public class HomeCommand implements ICommand
{
    ...
    {
        System.out.println("Enter HomeCommand.execute.");
        ...
        Object obj = request.getSession().getAttribute("loginUserId");
        if (obj != null)
        {
            CommandHelp.getOpenTable().removeWithUserId((Integer)obj);
        }
