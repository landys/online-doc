...
public class UserLoginClient implements UserLoginNamespaces
{
  ...
  public UserLoginClient(String instanceURI, boolean useSecurity) throws MalformedURIException, RemoteException, ServiceException {
   ...
   //this.instanceURI=instanceURI;
     ...
     * @generated
     */
    public zju.onlinedoc.meta.stubs.FileRecord[] getFileRecordArray() throws RemoteException  {
        
        zju.onlinedoc.meta.stubs.FileRecord[] retVal = this.port.getFileRecordArray(new GetFileRecordArray()).getGetFileRecordArrayReturn();
        return retVal;
     ...
     * @generated
     */
    public zju.onlinedoc.meta.stubs.UserInfo[] getUserNameArray(int fileId) throws RemoteException  {
        
        zju.onlinedoc.meta.stubs.UserInfo[] retVal = this.port.getUserNameArray(new GetUserNameArray(fileId)).getGetUserNameArrayReturn();
        return retVal;
	...
	public zju.onlinedoc.meta.stubs.FileRecord getFileRecord(int fileId) throws RemoteException  {
		...
		zju.onlinedoc.meta.stubs.FileRecord retVal = this.port.getFileRecord(new GetFileRecord(fileId)).getGetFileRecordReturn(); 
		return retVal;
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            String instanceURI = LoadProperties
                    .getInstance("config.properties").getProp(
                            "grid.url.UserLoginService");
            boolean useSecurity = false;
            UserLoginClient client = new UserLoginClient(instanceURI,
                    useSecurity);

            System.out.println(client.getFileRecordArray().length);
