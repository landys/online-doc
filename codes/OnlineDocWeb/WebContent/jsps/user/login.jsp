...
<!-- ************* can be replaced *************** -->
	...
	<table cellSpacing="0" cellPadding="0" width="645" border="0" align="center">
		<TR>
			...
			<TD class="wpsPortletTitle" width="600" background="../theme/background.gif" height="16">Login Please</TD>
		...
		<TR>
			...
			<TD vAlign="top" align="center" width="600" bgColor="#ffffff" height="100">
				<TABLE cellSpacing="0" cellPadding="2" width="100%" border="0">
					...
					<tr>
						<td colspan="2">
							<input type="submit" value="Login" onclick="action.value='doLogin'; return Validator.Validate(document.myform,3)"/>
						</td>
					</tr>
				</TABLE>
			</TD>
