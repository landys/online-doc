...
public class GetFileContent  implements java.io.Serializable {
    ...
    /**
     * Gets the fileId value for this GetFileContent.
     * 
     * @return fileId
     */
    ...
    /**
     * Sets the fileId value for this GetFileContent.
     * 
     * @param fileId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://zju.edu/onlinedoc/grid/userlogin/UserLogin", ">getFileContent"));
